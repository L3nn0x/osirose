...
{   
    ...
    {                     
        ...
        {                        
            ...
            {                                        
                ...
                for(unsigned int i=0;i<PartyExp.size();i++)
                {
                ...
                if( !pflag )
                {
                    ...
                    for(unsigned int p=0;p<thisclient->VisiblePlayers.size();p++)
                    {
    ...
    for(unsigned int p=0;p<PartyExp.size();p++)
    {
        CPartyExp* thisparty = PartyExp.at( p );
        for(unsigned int i=0;i<thisparty->num;i++)
        {
